...
# panelSuperior = Label(ventana, text = "Centinela", bg = "#2D3342", font = ("Arial Bold", 30)) # Creación de panel superior
# panelLateral = Label(ventana, bg = "#C4C4C4") # Creación de panel lateral

# panelSuperior.pack(fill = X) # Imprime a lo largo del eje 'x'
# panelLateral.pack(side = LEFT, fill = Y, expand = True) # Imprime del lado izquiero y a lo largo del eje 'y'
